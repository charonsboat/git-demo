...
// var handler = bot.scheduleTweet('[bot test] delayed tweet (10 seconds).', new Date((new Date()).getTime() + (10 * 1000)))
//     .then(function (result) {
//         console.log('Data: ', result.data);
//     })
//     .catch(function (error) {
...
// returning the resolver to chain onto the scheduler
...
// chaining onto the resolver inside the scheduler
var handler = bot.schedule(function () {
